import { CreateProfileReq } from '@core/api/model/api';
...
const createProfileFn = (newProfile: CreateProfileReq): ICreateProfileAction => ({
...
const createFirstProfileFn = (newProfile: CreateProfileReq): ICreateFirstProfileAction => ({
